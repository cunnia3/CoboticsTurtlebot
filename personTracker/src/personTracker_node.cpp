...
void XN_CALLBACK_TYPE User_NewUser(xn::UserGenerator& generator, XnUserID nId, void* pCookie) {
	...
	g_UserGenerator.GetCoM(nId, centerOfMass);
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle nh;
    //custom topic to publish to
    //publish center of mass for a user
    ros::Publisher CoM_pub = nh.advertise<geometry_msgs::Pose2D>("personCoM", 1000);
